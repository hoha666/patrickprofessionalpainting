...
namespace PatrickWebsiteCore.Controllers
{
    ...
    public class TestimonialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,Title,SingleWord")] Testimonial testimonial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Title,SingleWord")] Testimonial testimonial)
        {
